        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Favorit = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Associationss", x => x.AssociationId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Associationss_BookId",
                table: "Associationss",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_Associationss_UserId",
                table: "Associationss",
                column: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Associationss_Books_BookId",
                table: "Associationss",
                column: "BookId",
                principalTable: "Books",
                principalColumn: "BookId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Associationss_Users_UserId",
                table: "Associationss",
                column: "UserId",
